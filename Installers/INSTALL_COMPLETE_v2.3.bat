...
color 0B
title Pokemon TCG Live Monitor v2.3 - Professional Installation
...
schtasks /create /tn "PokemonTCGLiveMonitor_v2.3" /tr "\"%PYTHON_PATH%\" \"%SCRIPT_PATH%\" --headless" /sc onlogon /rl highest /f >nul 2>&1
...
echo     ================================================================
echo.
echo     What's New in v2.3:
echo       [+] Faster deck icon menus (cached sprites)
echo       [+] Fixed numpy/OpenCV compatibility for new installs
echo       [+] Improved local-only mode for users without an API key
echo.
echo     ================================================================
...
echo       - Or double-click: Installers\Start_GUI_Mode_v2.3.bat
echo.
...
echo     ================================================================
echo.
echo     Open Stats Dashboard:  Installers\Start_GUI_Mode_v2.3.bat
echo     Remove from Startup:   Installers\Remove_AutoStart_v2.3.bat

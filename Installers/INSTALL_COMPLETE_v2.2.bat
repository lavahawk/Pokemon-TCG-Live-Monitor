...
color 0B
title Pokemon TCG Live Monitor v2.2 - Professional Installation
...
echo       [+] OCR Rank + Deck Detection (Auto-Override)
...
echo     ================================================================
echo.
echo     The AI battle analyzer uses OpenAI GPT to identify decks.
echo.
echo     Options:
...
REM Remove any old scheduler tasks
...
schtasks /create /tn "PokemonTCGLiveMonitor_v2.2" /tr "\"%PYTHON_PATH%\" \"%SCRIPT_PATH%\" --headless" /sc onlogon /rl highest /f >nul 2>&1
...
echo.
echo     ================================================================
echo                    Installation Complete! v2.2
echo     ================================================================
echo.
echo     What's New in v2.2:
echo       [+] OCR deck name auto-overrides AI-assumed deck after battle
echo       [+] Database updated with real deck name from main menu OCR
echo       [+] Improved battle record accuracy
echo.
echo     ================================================================
...
echo       - Click the small overlay arrow (arrow) in-game
echo       - Or double-click: Installers\Start_GUI_Mode_v2.2.bat
echo.
...
echo     ================================================================
echo.
echo     Open Stats Dashboard:  Installers\Start_GUI_Mode_v2.2.bat
echo     Remove from Startup:   Installers\Remove_AutoStart_v2.2.bat
echo     Add to Startup:        Installers\AutoRun_Add.py
echo.
echo     ================================================================
echo                         Getting Help
echo     ================================================================
